        ...
        <table class="table table-hover">
            ...
            <tr>
                ...
                <%--<c:if test="${book.state != 0}">--%>
                    <%--<td><a href="lendbook.html?bookId=<c:out value="${book.bookId}"></c:out>"><button type="button" class="btn btn-primary btn-xs">购书</button></a></td>--%>
                <%--</c:if>--%>
                <%--<c:else>alert("余量不足!")</c:else>--%>
                <c:choose>
                    <c:when test="${book.state != 0}">
                        <td>
                            <a href="lendbook.html?bookId=<c:out value="${book.bookId}"></c:out>">
                                <button type="button" class="btn btn-primary btn-xs">购书</button>
                            </a>
                        </td>
                    </c:when>
                    <c:otherwise>
