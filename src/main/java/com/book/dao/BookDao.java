...
public class BookDao {
    ...
    private final static String ADD_BOOK_SQL="INSERT INTO book_info(name,author,publish,isbn,introduction,language,price,pubdate,class_id,pressmark,state) VALUES(?,?,?,?,?,?,?,?,?,?,?)";
