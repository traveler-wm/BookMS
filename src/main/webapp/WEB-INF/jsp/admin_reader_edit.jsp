...
<div class="col-xs-6 col-md-offset-3" style="position: relative;top: 30%">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">编辑会员信息《 ${readerInfo.readerId}》</h3>
        </div>
        <div class="panel-body">
            <form action="reader_edit_do.html?id=${readerInfo.readerId}" method="post" id="readeredit" >
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="balanced" id="balanced" value="${readerInfo.balanced}" >
                </div>
