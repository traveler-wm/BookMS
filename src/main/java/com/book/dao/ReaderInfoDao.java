...
public class ReaderInfoDao {
    ...
    private final static String UPDATE_READER_INFO="UPDATE reader_info set name = ? ,sex = ? ,birth = ? ,address = ? ,telcode = ?,balanced = ? where reader_id = ? ";
        ...
        jdbcTemplate.query(ALL_READER_INFO_SQL, new RowCallbackHandler() {
            public void processRow(ResultSet resultSet) throws SQLException {
                ...
                while (resultSet.next()){
                    ...
                    reader.setBalanced(resultSet.getBigDecimal("balanced"));
                    readers.add(reader);
                }
            }
        });
    ...
    public int editReaderInfo(ReaderInfo readerInfo){
        ...
        BigDecimal balanced = readerInfo.getBalanced();
        return jdbcTemplate.update(UPDATE_READER_INFO,new Object[]{name,sex,birth,address,telcode,balanced,readerId});
    }
    ...
    public int addReaderInfo(ReaderInfo readerInfo){
        ...
        return jdbcTemplate.update(ADD_READER_INFO_SQL,new Object[]{readerId,name,sex,birth,address,telcode,balanced});
    }
