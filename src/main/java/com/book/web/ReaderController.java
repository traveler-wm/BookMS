...
public class ReaderController {
    ...
    public String readerInfoEditDo(HttpServletRequest request,BigDecimal balanced,String name,String sex,String birth,String address,String telcode,RedirectAttributes redirectAttributes){
...
//            }
            ...
            readerInfo.setBalanced(balanced);
            boolean succ=readerInfoService.editReaderInfo(readerInfo);
            if(succ){
                redirectAttributes.addFlashAttribute("succ", "会员信息修改成功！");
                return "redirect:/allreaders.html";
            }else {
                redirectAttributes.addFlashAttribute("error", "会员信息修改失败！");
                return "redirect:/allreaders.html";
            }
        }
//        else {
...
//    }
    ...
    public String readerInfoAddDo(BigDecimal balanced, String name, String sex, String birth, String address, String telcode, int readerId, RedirectAttributes redirectAttributes){
        SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd");
        Date nbirth=new Date();
        try{
            java.util.Date date=sdf.parse(birth);
...
//        boolean succc=readerCardService.addReaderCard(readerInfo);
        ArrayList<ReaderInfo> readers=readerInfoService.readerInfos();
        if (succ){
            redirectAttributes.addFlashAttribute("succ", "添加会员信息成功！");
            return "redirect:/allreaders.html";
        }else {
            redirectAttributes.addFlashAttribute("succ", "添加会员信息失败！");
            return "redirect:/allreaders.html";
        }
    }
//读者功能--读者信息修改
    ...
    public String readerInfoEditDoReader(HttpServletRequest request,BigDecimal balanced,String name,String sex,String birth,String address,String telcode,RedirectAttributes redirectAttributes){
        ReaderCard readerCard=(ReaderCard) request.getSession().getAttribute("readercard");
